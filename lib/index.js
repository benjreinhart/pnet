...
void function () {
  var getParamErrors, normalizeMethod, omit, parseResponseBody, Path, pnet, pnetConfig, pnetDefaults, request, safeExtend, urlFor;
  Path = require('path');
  ...
  pnet.get = function (method, params, callback) {
    var cache$, cache$1, error, url, urlOnly;
    if (null == params)
      params = {};
